...
public final class CaptureActivityHandler extends Handler {
    ...
    private final CaptureActivityBase activity;
    ...
    public CaptureActivityHandler(CaptureActivityBase activity, Collection<BarcodeFormat> decodeFormats, Map<DecodeHintType, ?> baseHints, String characterSet,
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.scan_restart_preview) {
            ...
            restartPreviewAndDecode();
        } else if (message.what == R.id.scan_decode_succeeded) {
        ...
        } else if (message.what == R.id.scan_decode_failed) {
            // We're decoding as fast as possible, so when one decode fails,
            // start another.
            state = State.PREVIEW;
            cameraManager.requestPreviewFrame(decodeThread.getHandler(), R.id.scan_decode);
        } else if (message.what == R.id.scan_return_scan_result) {
            Log.d(TAG, "Got return scan result message");
            activity.getActivityContext().setResult(Activity.RESULT_OK, (Intent) message.obj);
             ...
             */
            ResolveInfo resolveInfo = activity.getActivityContext().getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY);
    ...
    public void quitSynchronously() {
        ...
        Message quit = Message.obtain(decodeThread.getHandler(), R.id.scan_quit);
        quit.sendToTarget();
