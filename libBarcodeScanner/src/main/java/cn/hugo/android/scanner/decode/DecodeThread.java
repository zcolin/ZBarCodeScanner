...
public final class DecodeThread extends Thread {
    ...
    public DecodeThread(CaptureActivityBase activity, Collection<BarcodeFormat> decodeFormats, Map<DecodeHintType, ?> baseHints, String characterSet,
        ...
        if (decodeFormats == null || decodeFormats.isEmpty()) {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(activity.getActivityContext());
